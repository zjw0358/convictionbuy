...
def send_mail(attachment,filedate,method = False):    
    try:
        if (not method):
            send_gmail(attachment,filedate)
        else:
            send_mail_in_office(attachment,filedate)
    except:
        print "Unexpected error:", sys.exc_info()[0]
        pass
    
def send_mail_in_office(attachment,filedate):
    test_str="CB_daily_report_"+filedate
...
if __name__ == "__main__":
    send_mail_office("../cache/dailyreport_2016-02-04.pdf","2016-02-04")
